<x-layout title="ConneCTION">
  <x-hero class="is-light"
          hero-body-class="has-flex has-flex-direction-col ml-5 has-text-centered">
    <h2 class="subtitle is-2 is-italic">
      Learn about CS, together<span class="has-text-primary">.</span>
    </h2>
    <x-logo class="tw-w-[min(500px, 100%)] tw-h-auto" />
    ...
    <div class="buttons is-justify-content-center">
      ...
      <a class="button is-primary is-outlined"
         href="{{ route('videos') }}">Learn More</a>
      <a class="button is-primary"
         href="{{ route('users.create') }}">Sign Up</a>
    </div>
  </x-hero>
  <x-container class="mt-5">
    ...
    <section class="columns">
      ...
      <div class="column is-one-third has-text-centered">
        <x-lucide-message-square width="50"
                                 height="50" />
