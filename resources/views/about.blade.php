<x-layout title="conneCTION - About Us">
  <main>
    <x-hero class="is-primary">
      <h1 class="title">About Us</h1>
    </x-hero>
    <section class="container is-fluid mt-5">
      <h2 class="title is-1">Where it started<span class="has-text-primary">.</span></h2>
      <hr>
      <section class="columns">
        ...
        <div class="column">
          <img src="images/airne_personnel.webp"
               alt="">
        </div>
      </section>
      <section class="columns">
        <div class="column">
          <img src="images/AIRNE-C1-5-MAP.webp"
               alt="">
        </div>
        <div class="column is-half content is-large">
          <h2 class="title is-1">The Idea<span class="has-text-primary">.</span></h2>
