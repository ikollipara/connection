{{--
file: resources/views/components/users/posts/row.blade.php
author: Ian Kollipara
date: 2024-06-17
description: The HTML for a row in the user's posts table
 --}}

@props(['item'])

@php
  $title = (bool) $item->title ? $item->title : 'Unnamed Post';
